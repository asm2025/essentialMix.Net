...
using essentialMix.Web.Formatters.Csv.Internal;
using JetBrains.Annotations;
using Microsoft.AspNetCore.Mvc.Formatters;

namespace essentialMix.Web.Formatters.Csv;
...
public class CsvOutputFormatter : TextOutputFormatter
{
	...
	/// <inheritdoc />
	[NotNull]
	public override async Task WriteResponseBodyAsync([NotNull] OutputFormatterWriteContext context, [NotNull] Encoding selectedEncoding)
	{
		...
		await using (TextWriter writer = context.WriterFactory(context.HttpContext.Response.Body, selectedEncoding))
		{
