...
using System.Linq;
using System.Xml;
using essentialMix.Web.Mvc.Formatters.Raw;
using essentialMix.Web.Mvc.Formatters.Raw.Internal;
using JetBrains.Annotations;
using Microsoft.AspNetCore.Mvc;
using Microsoft.AspNetCore.Mvc.Formatters;
using Microsoft.Net.Http.Headers;
using TextInputFormatter = essentialMix.Web.Mvc.Formatters.Text.TextInputFormatter;
using TextOutputFormatter = essentialMix.Web.Mvc.Formatters.Text.TextOutputFormatter;
...
public static class MvcOptionsExtension
{
	...
	public static MvcOptions ConfigureTextFormatter([NotNull] this MvcOptions thisValue)
	{
		...
		thisValue.FormatterMappings.SetMediaTypeMappingForFormat("plain", Web.Mvc.Formatters.Text.Internal.MediaTypeHeaderValues.TextPlain);
		return thisValue;
	}
