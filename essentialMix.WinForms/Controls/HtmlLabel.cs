...
public class HtmlLabel : Control
{
	...
	{
		if (disposing) ObjectHelper.Dispose(ref _bmpOffScr);
	...
	// ra�unanje velikosti elementov in dolo�anje posameznih vrstic
	private void CalculateLines(Graphics grOff)
	{
		...
		_textLines.Add(new TextLine(currWdth, currHgth, values.Count - 1)); // stra�ar
		_totalHeight += currHgth;
